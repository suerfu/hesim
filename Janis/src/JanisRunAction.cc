...
void JanisRunAction::BeginOfRunAction(const G4Run*)
{
...
void JanisRunAction::EndOfRunAction(const G4Run* run)
{
  ...
  const JanisPrimaryGeneratorAction* generatorAction
   = static_cast<const JanisPrimaryGeneratorAction*>
...
void JanisRunAction::AddEdep(G4double edep)
{
  fEdep  += edep;
  fEdep2 += edep*edep;
}
