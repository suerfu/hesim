...
void neutron_analysis_1(){
  // Read source root file
  string fname;
  string filename = "/global/home/users/yuanlq/McKinsey_Janis_Fridge/Janis-build/analysis/savio100million1.root";
  ...
  c -> SetLogy();
  // output file name
  fname = "All 8 far side detectors 1";
  h -> Draw();
