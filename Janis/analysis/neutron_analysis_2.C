...
void neutron_analysis_2(){
  // Read source root file
  string fname;
  string filename = "/global/home/users/yuanlq/McKinsey_Janis_Fridge/Janis-build/analysis/savio100million2.root";
  ...
  c -> SetLogy();
  // output file name
  fname = "All 8 far side detectors 2";
  h -> Draw();
