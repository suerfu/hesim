...
void neutron_analysis_5(){
  ...
  string fname;
  string filename = "/global/scratch/users/yuanlq/results/savio100million5.root";
  ...
  c -> SetLogy();
  // output file name
  fname = "All 8 far side detectors 5";
  h -> Draw();
