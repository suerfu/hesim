...
/*
/// \file Janis.cc
/// \brief Main program of the Janis
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new JanisDetectorConstruction());
  ...
  runManager->SetUserInitialization(new JanisActionInitialization());
